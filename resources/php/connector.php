...
$opts = array(
	'root'            => '../resources/',// path to root directory
	'URL'             => $_SESSION['_EQROOT_'].'resources/resources/', // root directory URL
	'rootAlias'       => 'Doucments & Resources',       // display this instead of root directory name
